...
public class FragmentFotoD extends Fragment{
    ...
    private String[] titulos = new String[]{"Días sin huella", "La tentación vive arriba","Con faldas y a lo loco", "El apartamento", "Aquí, un amigo"};
    private String nombreDirector = "Billy Wilder";

    public FragmentFotoD() {
    }

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_fotos_d, container, false);
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        Bitmap[] bitmaps = FragmentD.imagesD;
        if (bitmaps!=null){
            ...
            iv = (ImageView) getView().findViewById(R.id.image_viewD);
            iv.setImageBitmap(bit);
            like = (ImageView) getView().findViewById(R.id.likeD);
            dislike = (ImageView) getView().findViewById(R.id.dislikeD);
            like.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if(pos<4){
                        ...
                        resultados.setArrayList(arrayListResultados);
                        startActivity(new Intent(getActivity(), ResultadosActivity.class));
