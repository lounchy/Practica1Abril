...
public class FragmentFotoC extends Fragment{
    ...
    private String[] titulos = new String[]{"Los Idiotas","Bailando en la oscuridad", "Dogbille"," Anticristo", "Melancolia"};
    private String nombreDirector = "Lars Von Trier";

    public FragmentFotoC() {
    }

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_fotos_c, container, false);
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        Bitmap[] bitmaps = FragmentC.imagesC;
        if (bitmaps!=null){
            ...
            iv = (ImageView) getView().findViewById(R.id.image_viewC);
            iv.setImageBitmap(bit);
            like = (ImageView) getView().findViewById(R.id.likeC);
            dislike = (ImageView) getView().findViewById(R.id.dislikeC);
